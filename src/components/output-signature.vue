        ...
        <tr>
            <td valign="top" style="padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 7px; border-top: 0; border-bottom: 0: border-left: 0;">
              <a href="https://www.masterservicestn.com">
                <img v-show="mobilePhoneSwitch" width="220" height="139" style="width: 220px; max-width: 220px !important; height: 139px; max-height: 139px !important; margin-top: 5px;" id="preview-image-url" src="https://cdn.treehouseinternetgroup.com/cms_images/195/signature-logo-bar-master.jpg" name="preview-image-url" />
        
                <img v-show="!mobilePhoneSwitch" width="190" height="121" style="width: 190px; max-width: 190px !important; height: 121px; max-height: 121px !important; margin-top: 5px;" id="preview-image-url" src="https://cdn.treehouseinternetgroup.com/cms_images/195/signature-logo-bar-master.jpg" name="preview-image-url" />
              </a>
            </td>
            ...
            "background: none; border-width: 0px; border: 0px; margin: 0; padding: 0;">
              <tr>
                  <td colspan="2" style=
                  "padding-bottom: 5px; color: #00345c; font-size: 18px; font-family: Arial, Helvetica, sans-serif;">
                  {{fullName}}
                  </td>
                </tr>
                <tr>
              ...
              <div v-show="!mobilePhoneSwitch">
                ...
                <tr>
                  ...
                  "vertical-align: top; width: 20px; color: #00345c; font-size: 14px; font-family: Arial, Helvetica, sans-serif;">
                  Office:
                  </td>
                  <td valign="top" style=
                ...
                <tr>
                  <td colspan="2" style="padding-top: 5px;">
                    <a href="https://www.facebook.com/TheMasterTeamTN" target="_blank" style=
